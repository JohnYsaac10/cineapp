        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <c:forEach var="pelicula" items="${peliculas}">
			  <tr>
				...
				<td>
					<a href="${urlRoot}peliculas/edit/${pelicula.id}" class="btn btn-success btn-sm" role="button" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
					<a href="${urlRoot}peliculas/delete/${pelicula.id}/${pelicula.getDetalle().getId()}" onclick="return confirm('Estas seguro?')" class="btn btn-danger btn-sm" role="button" title="Eliminar"><span class="glyphicon glyphicon-trash"></span></a>
				</td>
			  </tr>
			</c:forEach>
